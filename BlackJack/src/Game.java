...
public class Game {
    ...
    String[] pSplited = new String[10];
    public int lenX = 2, lenY = 2, lenZ = 2;
    ...
    public String[] splitplayer() {
        pSplited[0] = player[1];
        pSplited[1] = cards[gameRand.nextInt(13)];
        return pSplited;
    }

    public String[] firsthandPlayer() {
        player[1] = cards[gameRand.nextInt(13)];
        return player;
    }
